...
Route::any('/f', function () {
    ...
    // return strtotime('04-12-2021');
    // strtotime($database_date) > strtotime('now')
    // 
    ...
    return App\Http\Controllers\DateAndTime::get_date_time_arr('04-12-2021');
...
Route::group(['prefix' => 'quotation'], function () {
    Route::any('get_pdf', 'QuotationController@get_pdf')->name('quotation.get_pdf');
});
// -----------------------------------------------------------------------------------------------------------------
Route::group(['prefix' => 'invoice'], function () {
    Route::any('get_pdf', 'InvoiceController@get_pdf')->name('invoice.get_pdf');
});
// -----------------------------------------------------------------------------------------------------------------
...
Route::resources([
    ...
    'projectBeneficiary' => 'ProjectBeneficiaryController',
