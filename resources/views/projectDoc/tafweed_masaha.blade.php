...
<body>
  ...
  <table>
    <tr>
      <th colspan="1" class="bg-blue-1">
        <br> <br> <br> <br>
        <span>تفويض للمكتب الهندسي</span>
      </th>
      <td colspan="5" class="bg-green-1">
        اقر أنا الموقع اسمي اعلاه , و انا باتم الاوصاف المعتبره شرعا بصفتي المالك للعقار المملوك بالصك الموضحه بياناته
        اعلاه . بأنني قد فوضت المكتب المذكور للقيام بمتابعة و انهاء اجراءات المعاملة الخاصة باصدار بيانات موقع و قرار
        مساحي والفرز والدمج . و اتعهد بما يلي :
        <ol>
          <li>
  ...
  <table>
    <tr>
      <td colspan="1" class="bg-blue-1">
        <br> <br>
        <span>اقرار استلام الموقع</span>
      </td>
      <td colspan="5" class="bg-green-1">
  ...
  <table>
    <tr>
      <th colspan="1" class="bg-blue-1">
        تعهد بمراجعة<br> البلدية الفرعية <br> قبل البدء في العمل
      </th>
      <td colspan="5" class="bg-green-1">
        ...
        <span><span> O </span>
          كروكي استدلالي للموقع .
        </span> <br>
        <span><span> O </span>
          صورة من عقد الاشراف للمباني أربعه أدوار فأكثر .
        </span>
        <span><span> O </span>
          نسخة من المخططات المعمارية مقاس (A3)
        </span><br>
        <span><span> O </span>
          صورة من محضر استلام المقاول للموقع من قبل المثبت له مساحيا .
        </span>
        <span><span> O </span>
          ملف علاقي.
        </span>
