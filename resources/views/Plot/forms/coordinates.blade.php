...
<div class="form-group row ">
    ...
    <div class="col-md">
        ...
        <input type="text" name="x_coordinate" class="form-control @error ('x_coordinate') is-invalid @enderror"
            ...
            placeholder="{{__( '5xxx')}}.." onfocus="this.placeholder=''" onblur="this.placeholder='{{__( '5xxx')}}..'">
        @error('x_coordinate')
    ...
    <div class="col-md">
        ...
        <input type="text" name="y_coordinate" class="form-control @error ('y_coordinate') is-invalid @enderror"
            ...
            placeholder="{{__( '2xxx')}}.." onfocus="this.placeholder=''" onblur="this.placeholder='{{__( '2xxx')}}..'">
        @error('y_coordinate')
