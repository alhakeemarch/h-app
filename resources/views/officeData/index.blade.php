...
{{-- <div class="card">
    <h3 class="h3 text-center">
        list of all offices in the app <p class="small">total = {{ count($saudi_cities) }}</p>
</h3>
    ...
    <thead class="bg-thead">
        <tr>
            ...
            <th scope="col">اسم المدينة
                <input type="text" id='ar_city_name' name="ar_city_name_input" class="form-control" autocomplete="off"
                    required placeholder="{{__( 'search..')}}" onfocus="this.placeholder=''"
                    onblur="this.placeholder=' {{__( 'search..')}}'" onkeyup="filterNames(event)"
