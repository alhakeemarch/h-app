<nav class="navbar navbar-expand-lg navbar-dark h-navbar-bg text-capitalize">
    ...
    <li class="nav-item dropdown">
        {{-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false"> {{__('data')}} &nbsp;</a> --}}
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            {{-- @if (auth()->user()->user_level >= 10 or true)
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="{{ route ('municipalityBranch.index') }}">{{__('municipalities')}}</a>
            ...
            <a class="dropdown-item" href="{{ route ('allowedBuildingRatio.index') }}">{{__('building ratio')}}</a>
            <a class="dropdown-item" href="{{ route ('allowedBuildingHeight.index') }}">{{__('building height')}}</a>
            <div class="dropdown-divider"></div>
    ...
    <li class="nav-item dropdown">
        {{-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false"> {{__('accounting')}}
            &nbsp;</a> --}}
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="{{ route ('receiptDiscount.index') }}">{{__('receipt discount')}}</a>
            <div class="dropdown-divider"></div>
    ...
    <li class="nav-item dropdown">
        {{-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false"> {{__('administratives')}}
            &nbsp;</a> --}}
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @guest
        <li class="nav-item">
            <a class="nav-link" href="{{ route('login.check') }}">{{ __('Login') }}</a>
        </li>
