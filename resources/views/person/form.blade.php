...
<div class="form-group">
    ...
    <div class="form-row mb-3">
        <div class="col-md">
            <input type="text" name="ar_name1" id="" class="form-control" placeholder="{{ __('name1') }}.." required
                onkeypress="onlyArabicString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="ar_name2" id="" class="form-control" placeholder="{{__( 'name2')}}.."
                onkeypress="onlyArabicString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="ar_name3" id="" class="form-control" placeholder="{{__( 'name3')}}.."
                onkeypress="onlyArabicString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="ar_name4" id="" class="form-control" placeholder="{{__( 'name4')}}.."
                onkeypress="onlyArabicString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="ar_name5" id="" class="form-control" placeholder="{{__( 'name5')}}.." required
                onkeypress="onlyArabicString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
    </div>
    <!-- end form-row -->
...
<div class="form-group">
    ...
    <div class="form-row mb-3">
        <div class="col-md">
            <input type="text" name="en_name1" id="" class="form-control" placeholder="{{ __('name1') }}.."
                onkeypress="onlyEnglishString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="en_name2" id="" class="form-control" placeholder="{{__( 'name2')}}.."
                onkeypress="onlyEnglishString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="en_name3" id="" class="form-control" placeholder="{{__( 'name3')}}.."
                onkeypress="onlyEnglishString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="en_name4" id="" class="form-control" placeholder="{{__( 'name4')}}.."
                onkeypress="onlyEnglishString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
        <div class="col-md">
            <input type="text" name="en_name5" id="" class="form-control" placeholder="{{__( 'name5')}}.."
                onkeypress="onlyEnglishString(event)" pattern=".{2,}" title="{{__('minimum 2 letters')}}">
        </div>
    </div>
    <!-- end form-row -->
...
<div class="form-group">
    <div class="form-row mb-3">
        <div class="col-md">
            ...
            <input type="text" name="mobile" id="" class="form-control mb-3" placeholder="{{__( 'phoneNo')}}.."
                aria-describedby="helpId" onkeypress="onlyNumber(event)" maxlength="10" pattern=".{10,}" required
