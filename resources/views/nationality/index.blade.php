        ...
        <table class="table table-hover text-capitalize">
            <thead class="bg-thead">
                <tr>
                    ...
                    <th scope="ar_nationality">nationality in arabic
                    ...
                    <th scope="en_nationality">nationality in english
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="ar_nationality" class="ar_nationality_input">{{$nationality->ar_name }}</td>
                    <td scope="en_nationality" class="en_nationality_input">{{$nationality->en_name}}</td>
