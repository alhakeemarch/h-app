            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('person/check') }}" method="post">
                        ...
                        <input type="text" name="n_id" id="" class="form-control mb-3"
                            placeholder="{{__( 'nIdNumber')}}..">
                            ...
                            <div class="form-row mb-3">
                                <div class="col-md">
                                    <input type="text" name="fname" id="" class="form-control"
                                        placeholder="{{ __('name1') }}.." required>
                                </div>
                                <div class="col-md">
                                    <input type="text" name="name2" id="" class="form-control"
                                        placeholder="{{__( 'name2')}}..">
                                </div>
                                <div class="col-md">
                                    <input type="text" name="name3" id="" class="form-control"
                                        placeholder="{{__( 'name3')}}..">
                                </div>
                                <div class="col-md">
                                    <input type="text" name="name4" id="" class="form-control"
                                        placeholder="{{__( 'name4')}}..">
                                </div>
                                <div class="col-md">
                                    <input type="text" name="name5" id="" class="form-control"
                                        placeholder="{{__( 'name5')}}.." required>
                                </div>
                            </div>
                            <!-- end form-row -->
                            <label for="fname">{{__( 'nId')}}:</label>
                            <input type="text" name="fname" id="" class="form-control mb-3"
                                placeholder="{{__( 'nIdNumber')}}.." aria-describedby="helpId">
